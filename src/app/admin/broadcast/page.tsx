...
import { Send, Bell, Mail, Loader2, ArrowLeft, Megaphone, CheckCircle2, History, LogOut } from "lucide-react";
            ...
            <div className="md:hidden sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 px-6 py-4 flex items-center justify-between shadow-sm -mx-6 -mt-6 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <h2 className="text-[13px] font-black font-serif text-[#881337] leading-none">Broadcast</h2>
