...
import {
    Send, Loader2, Smartphone, CheckCircle2, History,
...
export default function SmsBroadcastTab() {
    const { user } = useAuth();
        ...
        <div className="space-y-6">
            <div className="bg-rose-50 border border-rose-100 p-6 rounded-3xl flex items-center justify-between">
                <div className="flex gap-4 items-center">
                    <div className="w-12 h-12 bg-[#881337] text-white rounded-2xl flex items-center justify-center shadow-lg">
                        <Smartphone className="w-6 h-6" />
                    </div>
                    <div>
                        <h3 className="text-[#881337] font-black text-xl">SMS Gateway</h3>
                        <p className="text-rose-600 text-sm font-medium">Manage SMS broadcasts and track delivery status via Textbee.</p>
                    </div>
                </div>
            </div>
                            ...
                            <div className="divide-y divide-gray-50 max-h-[600px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200">
                                ...
                                {filteredNumbers.length > visibleCountNumbers && (
                                    <div className="p-4 flex justify-center bg-gray-50/30">
                                        ...
                                        >
                                            <RefreshCw className="w-3 h-3" /> Load More Numbers
                                        </button>
                                    </div>
                                )}
                            </div>
