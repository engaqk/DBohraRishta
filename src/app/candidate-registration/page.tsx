...
import { User, Sparkles, Loader2, BookOpen } from "lucide-react";
                                    ...
                                    {user && (
                                        <div className="bg-rose-50 rounded-xl p-4 border border-rose-100 shadow-inner mt-2">
                                            ...
                                            <p className="text-[11px] text-rose-800 mb-3 leading-relaxed font-medium">
                                                If you logged in via email and haven't set up the mobile authenticator, please log out, select <strong>Mobile</strong> login, and follow the simple setup guide to get your code.
                                            </p>
